...
{
    [TestFixture]
    public class DECTestCase: BaseInstTest
    {
        [Test]
        public void Process_Should_Arithmetic_INC()
        {
            ...
            Assert.AreEqual(3, context.GetSymbolValue("main_x_0"));
            Assert.AreEqual(7, context.GetSymbolValue("main_y_0"));
            Assert.AreEqual(8, context.GetSymbolValue("main_z_0"));
            Assert.AreEqual(15, context.GetSymbolValue("main_t_0"));
        }
            ...
            var list = new List<Instruction>
                           {
                               ...
                               new Instruction(OpCode.DEC, 2, new Operand(OperandType.Variable, "x")), 
                               ...
                               new Instruction(OpCode.DEC, 2, new Operand(OperandType.Variable, "y")), 
                               ...
                               new Instruction(OpCode.DEC, 2, new Operand(OperandType.Variable, "z")), 
                               ...
                               new Instruction(OpCode.DEC, 2, new Operand(OperandType.Variable, "t")), 
